...
<style>
   ...
   .topimg1{
	...
	.modal-state1:checked + .modal1 {
	  opacity: 1;
	  visibility: visible;
	}
	
	.modal-state1:checked + .modal1 .modal__inner1 {
	  top: 0;
	}
	...
	.modal_close1:hover:after,
	.modal_close1:hover:before {
	  background: #aaa;
	}
...
<div class="container">
	...
	<div class="top">
		<div style="width: 15%;">
			<span class="openmenu" onclick='openNav()'>
		 		<img class="topimg1" src="images/menu.png" >
		 	</span>
		 </div>
		<div class="logo"><a href="Main.jsp" style="text-decoration:none; color:#f1f2f2; text-align:center"> SPark </a></div>
	</div>
	-->
	...
	<div id="map">
		...
		<!--========================== 주차종료 버튼 =================================-->
		<div class="topbtn">
			<label class="btn1" for="open-pop1">
				<a href="#"  style="text-decoration:none; color:#f1f2f2; text-align:center">주차종료</a>
			</label>
		</div>
		
		<!--========================= 주차종료 확인 팝업  ====================================-->
		<input class="modal-state1" id="open-pop1" type="checkbox" />
		<div class="modal1">
		  <label class="modal_bg1" for="open-pop1"></label>
		  <div class="modal_inner1">
		    <p style="font-size: 16px; font-weight: 470; padding-left: 30px; margin-top: 23px;"> 주차를 종료하시겠습니까? </p>
		    <div class="p2"><a href="prePay.jsp" style="text-decoration:none; color:#EB087D;"> 확인 </a></div>
		    <div class="p3"><a href="Main.jsp" style="text-decoration:none; color:#EB087D;"> 취소 </a></div>
		  </div>
		</div>
	...
	<script type="text/javascript">
		...
		function displayMarker(positions){
			...
			kakao.maps.event.addListener(marker,'click',function(mouseEvent){
                ...
                '<p id="parkInfoParkName" class="title">' + park_title[0] + '</p>' +
                ...
                '<div><p class="park_start">주차중</p></div></div>';
